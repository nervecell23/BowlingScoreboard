...
function BowlingBoard () {
  ...
  BowlingBoard.prototype.updateBonus = function(){
    ...
    for(var i = 0; i < numberOfFrames; i++){
      ...
      console.log("DEBUG: currentFrame::::::::::::")
      console.log(currentFrame)

      if(currentFrame.result === "strike" && currentFrame.bonus.length == 2){continue;}
      if(currentFrame.result === "spare" && currentFrame.bonus.length == 1){continue;}
